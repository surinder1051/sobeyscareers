...
if (class_exists('fp\Component')) {
    class recipe_steps extends fp\Component
    {
        ...
        public $component                         = 'recipe_steps'; // Component slug should be same as this file base name
        public $component_name                    = 'Recipe Steps'; // Shown in BB sidebar.
        public $component_description             = 'List the steps for recipe post type.';

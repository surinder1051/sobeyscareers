...
if (class_exists('fp\Component')) {
    class steps extends fp\Component
    {
        ...
        public $component                         = 'steps'; // Component slug should be same as this file base name
        public $component_name                    = 'steps'; // Shown in BB sidebar.
                    ...
                    'sections'      => array(
                        'attributes' => array(
                            ...
                            'fields'    => array(
                                ...
                                'steps_meta_key' => array(
                                    'type'     => 'text',
                                    'label'    => __('Steps Meta Key', FP_TD),
                                    'default'  => 'steps',
                                ),
                            ),
                        ),
        ...
        {
            global $post;
            $atts['steps'] = get_field($atts['steps_meta_key'], $post->ID);
            return $atts;
        }
    }
    new steps;

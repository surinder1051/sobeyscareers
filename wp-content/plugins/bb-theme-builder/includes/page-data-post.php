 ...
 * Post type
 */
FLPageData::add_post_property( 'post_type', array(
	'label'  => __( 'Post Type', 'bb-theme-builder' ),
	'group'  => 'posts',
	'type'   => 'string',
	'getter' => 'FLPageDataPost::get_post_type',
) );

/**
 * Post type labels
 */
// FLPageData::add_post_property( 'post_type_labels', array(
// 	'label'  => __( 'Post Type Labels', 'bb-theme-builder' ),
// 	'group'  => 'posts',
// 	'type'   => 'string',
// 	'getter' => 'FLPageDataPost::get_post_type_labels',
// ) );

FLPageData::add_post_property_settings_fields( 'post_type', array(
	'display' => array(
		'type'    => 'select',
		'label'   => __( 'Display', 'bb-theme-builder' ),
		'default' => 'slug',
		'options' => array(
			'slug'          => __( 'Post Type Slug (Default)', 'bb-theme-builder' ),
			'singular_name' => __( 'Post Type Singular Name', 'bb-theme-builder' ),
			'name'          => __( 'Post Type Name', 'bb-theme-builder' ),
			'not_found'     => __( 'No Posts Found', 'bb-theme-builder' ),
		),
	),
) );
